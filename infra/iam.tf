...
resource "aws_iam_role" "service_workload" {
...
resource "aws_iam_policy" "service_workload" {
  name   = "${local.name}-workload"
  policy = data.aws_iam_policy_document.service_workload.json

  tags = local.common_tags
}

resource "aws_iam_role_policy_attachment" "service_workload" {
  role       = aws_iam_role.service_workload.name
  policy_arn = aws_iam_policy.service_workload.arn
}
